  ...
  return (
    <div className="banner position-relative">
        ...
        <Swiper
            ...
            className="mySwiper"
        >                
            <SwiperSlide className='portSlide justify-content-center'>
                <img src='/img/portfolio/portfolio.jpg' className="portimg"></img>
            </SwiperSlide>
            <SwiperSlide><img src='/img/portfolio/portfolio2.jpg'  className="portimg"></img></SwiperSlide>
            <SwiperSlide><img src='/img/portfolio/portfolio3.jpg'  className="portimg"></img></SwiperSlide>  
        </Swiper> 
        <div className="container position-absolute end-0 start-0 top-0 d-flex flex-nowrap flex-md-row align-content-center align-items-center justify-content-start ">
            <ul className="d1ul d-flex position-absolute">
                <li className= "d1li me-5 mb-3 position-relative on">
                    <h3 className=' text-nowrap'>포트폴리오 A형</h3>
                    <ul className="d2ul">
                        <li className="d2li">
                            <p>#그누보드</p>
                ...
                <li className="d1li me-5 position-relative">
                    <h3 className=' text-nowrap'>포트폴리오 B형</h3>
                    <ul className= "d2ul">
                        <li className="d2li">
                            <p>#그누보드</p>
                        </li>
                ...
                <li className=" d1li me-5 position-relative">
                    <h3 className=' text-nowrap'>포트폴리오 C형</h3>
                    <ul className="  d2ul ">
                        <li className="d2li">
                            <p>#그누보드</p>
                        </li>
